...
export const CTagLabel: DefineComponent<CTagLabelProps> = defineComponent({
  props: {
    ...vueThemingProps,
  },
...
export const CTagCloseButton: DefineComponent<CTagCloseButtonProps> =
  defineComponent({
...
export const CTag: DefineComponent<CTagProps> = defineComponent({
  props: TagProps,
  setup(props, { slots, attrs }) {
    const themingProps = computed<ThemingProps>(() =>
      filterUndefined({
